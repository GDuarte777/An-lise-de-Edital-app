// GERADO POR scripts/gerar-motor.cjs — NÃO EDITE À MÃO.
// Fonte: extensao-lancebot/margem.js, extensao-lancebot/conteudo.js
 ...
 */
export const FONTE_MOTOR_EXTENSAO = `/* ===== extensao-lancebot/margem.js ===== */
/**
